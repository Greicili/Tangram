    ...
    : QDialog (parent)
{
    ...
    //Criando os vetores de peças e de sombras
    addShadow();
    addPieces();
...
void Tangram::setCompleted(){
   QMessageBox::information(this, tr("---- O TANGRAM ESTÁ COMPLETO ----"),
